<script>
    const vocabulary = {
        ...
        popup_master_enrol_text_one: {
            ru: "Отслеживайте статус записи на соответствующей странице, чтобы попасть на неё, нажмите на меню и выберите её",
            ua: "Відслідковувати статус запису на відовідній сторінці, щоб потрапити на неї, натисніть на меню та оберіть її."
        },
        popup_master_enrol_text_two: {
            ru: "Когда администратор рассмотрит вашу запись, её статус изменится и вам перезвонят",
            ua: "Коли адміністратор розгляне ваш запис, то статус зміниться та вам зателефонують."
        },
