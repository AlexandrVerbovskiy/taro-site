...
@section('content')
    <div class="container">
        <h3 class="text-center title_margin" style="margin: 24px 0">Навчання</h3>
    ...
    <script>
        ...
        buildModal("danger", "Видалення поста навчання", "Ви впевнені, що хочете видалити цей пост навчання?", document.querySelector("#trash-modal"), acceptDelete);
    </script>
@stop
