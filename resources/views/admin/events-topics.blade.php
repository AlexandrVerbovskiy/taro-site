...
@section('content')
    <div class="container">
        <h3 class="text-center title_margin" style="margin: 86px 0 30px">Категорії подій</h3>
            ...
            <table class="table admin_3_table_sm">
                ...
                @foreach ($topics as $topic)
                    <tr data-id="{{$topic->id}}">
                        ...
                        <td>
                            <a href="{{url("/admin/edit-topic-event/".$topic->id)}}" type="button" class="btn btn-primary admin_button_SaniaZaebalEdition">
