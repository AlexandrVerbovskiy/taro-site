...
@section('content')
    <div class="container">
        ...
        <div class="table table-responsive table-responsive-sm" style="">
            <table class="table admin_master_table_sm" style="">
                <thead>
                <tr>
                    <th scope="col">#</th>
                ...
                @foreach ($masters as $master)
                    <tr data-id="{{$master->id}}">
                        ...
                        <td >
                            <a href="{{url("/admin/edit-master/".$master->id)}}" type="button" class="btn btn-primary admin_button_SaniaZaebalEdition">
                            ...
                            <button type="button" class="btn admin_button_SaniaZaebalEdition change-visible @if($master->hidden) btn-danger @else btn-success @endif" data-id="{{$master->id}}">
                            ...
                            <button type="button" class="btn trash btn-danger admin_button_SaniaZaebalEdition" data-id="{{$master->id}}">
    ...
    <script>
        ...
        buildModal("danger", "Видалення майстра", "Ви впевнені, що хочете видалити цього майстра?", document.querySelector("#trash-modal"), acceptDelete, "Видалити");
    </script>
@stop
