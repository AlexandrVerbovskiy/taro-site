                ...
                @foreach ($masters as $master)
                    <tr data-id="{{$master->id}}">
                        ...
                        <td style="width: 100px;">
                            <a href="{{url("/admin/edit-master/".$master->id)}}" type="button" class="btn btn-primary admin_button2">
                            ...
                            <button type="button" class="btn admin_button2 change-visible @if($master->hidden) btn-danger @else btn-success @endif" data-id="{{$master->id}}">
                                <div class="d-flex justify-content-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <button type="button" class="btn trash btn-danger admin_button2" data-id="{{$master->id}}">
                                <div class="d-flex justify-content-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
