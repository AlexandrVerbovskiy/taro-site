...
@section('content')
    <div class="container">
        <h3 class="text-center title_margin" style="margin: 24px 0">Напрямки діяльності</h3>
                ...
                @foreach ($activities as $activity)
                    <tr data-id="{{$activity->id}}">
                        ...
                        <td class="" style="width: 100px;">
                            <a href="{{url("/admin/edit-activity/".$activity->id)}}" type="button" class="btn btn-primary admin_button_SaniaZaebalEdition" style="">
                            ...
                            <button type="button" class="btn admin_button_SaniaZaebalEdition change-visible @if($activity->hidden) btn-danger @else btn-success @endif" data-id="{{$activity->id}}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <button type="button" class="btn trash btn-danger admin_button_SaniaZaebalEdition" data-id="{{$activity->id}}">
    ...
    <script>
        ...
        buildModal("danger", "Видалення напрямка діяльності", "Ви впевнені, що хочете видалити цей напрям діяльності?", document.querySelector("#trash-modal"), acceptDelete);
    </script>
@stop
