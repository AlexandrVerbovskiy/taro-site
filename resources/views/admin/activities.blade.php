...
@section('content')
    <div class="container">
        <h3 class="text-center title_margin" style="margin: 30px 0 30px">Напрямки діяльності</h3>
        ...
        <table class="table table-responsive table-responsive-sm scroll_table" style="width: 100%">
            <thead>
            <tr>
                <th scope="col">#</th>
            ...
            @foreach ($activities as $activity)
                <tr data-id="{{$activity->id}}">
                    ...
                    <td class="" style="width: 100px;">
                        <a href="{{url("/admin/edit-activity/".$activity->id)}}" type="button" class="btn btn-primary admin_button2">
                        ...
                        <button type="button" class="btn admin_button2 change-visible @if($activity->hidden) btn-danger @else btn-success @endif" data-id="{{$activity->id}}">
                            <div class="d-flex justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        ...
                        <button type="button" class="btn trash btn-danger admin_button2" data-id="{{$activity->id}}">
                            <div class="d-flex justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
