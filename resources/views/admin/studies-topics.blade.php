...
@section('content')
    <div class="container">
        <h3 class="text-center title_margin" style="margin: 24px 0">Категорії навчання</h3>
            ...
            <table class="table admin_3_table_sm">
                ...
                @foreach ($topics as $topic)
                    <tr data-id="{{$topic->id}}">
                        ...
                        <td>
                            <a href="{{url("/admin/edit-study-topic/".$topic->id)}}" type="button" class="btn btn-primary admin_button_SaniaZaebalEdition">
                            ...
                            <button type="button" class="btn admin_button_SaniaZaebalEdition change-visible @if($topic->hidden) btn-danger @else btn-success @endif" data-id="{{$topic->id}}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <button type="button" class="btn trash btn-danger admin_button_SaniaZaebalEdition" data-id="{{$topic->id}}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
    ...
    <script>
        ...
        buildModal("danger", "Видалення категорії навчання", "Ви впевнені, що хочете видалити цю категорію навчання?", document.querySelector("#trash-modal"), acceptDelete);
    </script>
@stop
