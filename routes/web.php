...
Route::get("/user/notes-to-studies", [StudiesAppointmentsController::class, 'userNotes']);
Route::get("/user/notes-to-masters", [MastersAppointmentsController::class, 'userNotes']);
